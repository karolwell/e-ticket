/*! JsBarcode v3.8.0 | (c) Johan Lindell | MIT license */ ! function(t) {
    function e(r) {
    ...
    var s = function() {
        ...
        b = function(t) {
            function e(t, n) {
                o(this, e);
                var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                if (r.isValid = !1, -1 !== t.search(/^[0-9]{6}$/)) r.middleDigits = t, r.upcA = u(t, "0"), r.text = n.text || "" + r.upcA[0] + t + r.upcA[r.upcA.length - 1], r.isValid = !0;
                else {
            ...
            return a(e, t), s(e, [{
                ...
                value: function() {
                    var t = new c.default,
                        e = "";
                    return e += "101", e += this.encodeMiddleDigits(t), e += "010101", {
                        data: e,
                        text: this.text
                    }
                }
                ...
                value: function(t) {
                    var e = this.upcA[0],
                        n = this.upcA[this.upcA.length - 1],
                        r = y[parseInt(n)][parseInt(e)];
