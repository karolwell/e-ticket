...
class AchatDetails extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(Ticket::className(), ['id' => 'ticketId'])->inverseOf('achatDetails');
    }
    ...
    {
        return $this->hasOne(Achat::className(), ['id' => 'achatId'])->inverseOf('achatDetails');
    }
    ...
    {
        return $this->hasMany(Transfert::className(), ['achat_detailsId' => 'id'])->inverseOf('achatDetails');
    }
    ...
    {
        return $this->hasMany(Validation::className(), ['achat_detailsId' => 'id'])->inverseOf('achatDetails');
    }
}
