      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p id="text-confirm">Modal body text goes here.</p>
          </div>
          <div class="modal-footer">
            <button class="btn btn-outline-secondary btn-sm" type="button" data-dismiss="modal">Annuler</button>
            <button class="btn btn-primary btn-sm" type="button">Valider</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="">
    ...
    <!-- Off-Canvas Wrapper
      <div class="offcanvas-wrapper">-->
        <!-- Page Title-->
        <div class="" style="height: 75px; padding: -20px;">
          <div class="">
            <div class="" style="background: #606975; border-radius:2px; box-shadow: 3px 2px 7px #606975; position: fixed;
             width: 99.9%; z-index: 1000; margin-left: 1px; margin-top: -10px;">
              <h3 style="padding-top: 0px; padding: 10px; color: #fff; text-align: center;"><i class="fa fa-print"></i> Espace editeur</h3>
            </div>
<!--           <div class="column">
      ...
      <div class="container">
        <div class="row">
          <div style="position: fixed; margin-left: -5%;" class="col-md-2">
            <?= $this->render("menu_") ?>
          </div>
          <div style="margin-left: 20%;" class="col-sm-9 col-md-9">
            <div class="">
            <div class="" style="">
              <?= Breadcrumbs::widget([

                'links' => isset($this->params['breadcrumbs']) ? $this->params['breadcrumbs'] : [],
                'homeLink'=>['label'=>'Accueil', 'url'=>Yii::$app->homeUrl.'editeur/bord/index'],
/*                'tag'=>'ul',
                'itemTemplate'=>'<li style="display:inline; text-decoration:none;">{link}</li>',
                'options' => [
                  'style'=>'background:#0da9ef;',
                ],*/
