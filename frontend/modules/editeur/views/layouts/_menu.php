...
use frontend\modules\editeur\models\Compte; 
?>
              ...
              <?php if(Yii::$app->user->isGuest): ?>
                <div class="account"><a href="#"></a><i class="fa fa-cog"></i>
                  <div class="toolbar-dropdown">
                    ...
                    <li><a href="<?php echo Yii::$app->homeUrl ?>site/login"> <i class="fa fa-home"></i>Connexion</a></li>

                    <li class="sub-menu-separator"></li>
                    <li><a href="<?php echo Yii::$app->homeUrl ?>site/signup"> <i class="fa fa-unlock"></i>Inscription</a></li>
                  </div>
                </div>
                <?php else: ?>
                ...
                <?php if(!Yii::$app->user->isGuest): ?>
                  <div class="btn-sm btn btn-primary"><a href="#"></a><i class="fa"></i>Solde | <strong class="subtotal"><?php $compte=Compte::find()->where(['userId'=>Yii::$app->user->identity->id])->one(); echo $compte?  $compte->solde: 0 ?> F CFA</strong>
                  </div>
                <?php endif ?>
              </div>
            </div>
