        ...
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
            <div class="from-bottom"><img class="d-inline-block w-300 mb-4" src="<?php echo Yii::$app->homeUrl ?>img/hero-slider/logo02.png" alt="Puma">
              ...
              <div class="h2 text-body text-normal mb-4 pb-1">Votre téléphone est votre <span class="text-bold">Ticket</span></div>
...
<!-- Top Categories-->
<section class="container padding-top-1x bg-faded" style="padding: 20px 0px 20px 0px;">
      ...
      <section class="padding-top padding-bottom-x" style="padding-left: 10%; padding-right: 10%;">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-8" >
            <h6 class=" text-normal text-uppercase padding-top-1x mt-1">Les tickets</h6>
