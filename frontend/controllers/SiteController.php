...
{ 
    ...
    /**
      ...
      public function actionActivites()
      {
          ...
          $dataProvider = $dataProvider = new ActiveDataProvider([
              'query' => Activite::find()->where('etat='.Activite::STATUS_ACTIVE)->orderby('datefin ASC'),
              ]); 

          //print_r($dataProvider); exit;
          return $this->render('..\activite\index', [
              //'searchModel' => $searchModel,
              'dataProvider' => $dataProvider,
              ]);
      }
    ...
    //print_r($session['all']);exit;
      ...
      return $this->render('..\ticket\index', [
            //'searchModel' => $searchModel,
        'dataProvider' => $dataProvider,
        ]);
    }
